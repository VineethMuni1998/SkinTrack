...
;
;
const { handlers, auth, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
const { GET, POST } = handlers;
;
}),
"[project]/app/api/routines/[id]/timeline/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        const routineId = contextRoutineId || request.nextUrl.pathname.split("/api/routines/")[1]?.split("/")[0];
        if (!routineId) {
        ...
        const routine = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routine.findFirst({
            where: {
                id: routineId,
        ...
        const routineProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routineProduct.findMany({
            where: {
                routineId
            },
            include: {
        ...
        const photos = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].photo.findMany({
            where: {
                routineId
            },
            orderBy: {
        ...
        const latestAnalysis = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].analysis.findFirst({
            where: {
                routineId
            },
            orderBy: {
        ...
        if (latestAnalysis?.timeline && typeof latestAnalysis.timeline === "object") {
            const timeline = latestAnalysis.timeline;
        ...
        routineProducts.forEach((rp)=>{
            ...
            const expectedTimeframe = rp.expectedResultsTimeframe || analysisTimeframes[rp.productId] || null;
            const addedDate = new Date(rp.addedAt);
            const now = new Date();
            const daysSinceAddition = Math.floor((now.getTime() - addedDate.getTime()) / (1000 * 60 * 60 * 24));
            const expectedDays = parseTimeframeToDays(expectedTimeframe);
            const isTimeframePassed = expectedDays !== null && daysSinceAddition >= expectedDays;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a902d4a._.js.map