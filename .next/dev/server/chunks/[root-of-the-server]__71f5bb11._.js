...
async function analyzeProducts(products, userContext) {
...
async function POST(request) {
    try {
        ...
        let finalIngredients = ingredients?.trim() || null;
        if (!finalIngredients) {
            try {
                finalIngredients = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$openai$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchProductIngredients"])({
                    name,
                    brand,
                    category,
                    description
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71f5bb11._.js.map