...
const parseTimeOfDay = (value, defaultValue = "MORNING")=>{
    if (typeof value !== "string") return defaultValue;
    const normalized = value.trim().toUpperCase();
    if (normalized === "MORNING" || normalized === "NIGHT" || normalized === "BOTH") {
        return normalized;
    }
    return defaultValue;
};
async function GET(request) {
    try {
        ...
        const routines = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routine.findMany({
            where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0053097e._.js.map