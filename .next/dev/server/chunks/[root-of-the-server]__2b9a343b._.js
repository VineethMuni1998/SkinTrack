...
"[project]/app/api/routines/[id]/products/[productId]/step/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, context) {
    try {
        ...
        const routineProductId = context?.params?.productId || request.nextUrl.pathname.split("/products/")[1]?.split("/")[0];
        ...
        const routineProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routineProduct.findFirst({
            where: {
                id: routineProductId,
                routineId
            },
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routineProduct.update({
            where: {
                id: routineProductId
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b9a343b._.js.map