...
async function GET(request) {
    try {
        ...
        const photosWithProducts = await Promise.all(photos.map(async (photo)=>{
            if (photo.routineProductId) {
                const routineProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routineProduct.findUnique({
                    where: {
                        id: photo.routineProductId
                    },
                    include: {
                        product: {
                            select: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__73bb9ea5._.js.map