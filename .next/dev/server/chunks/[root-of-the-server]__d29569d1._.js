...
"[project]/app/api/routines/[id]/products/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    try {
        const routineId = context?.params?.id || request.nextUrl.pathname.split("/api/routines/")[1]?.split("/")[0];
        if (!routineId) {
        ...
        const { productId, timeOfDay } = body;
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routineProduct.findFirst({
            where: {
                routineId,
                productId,
        ...
        const routineProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routineProduct.create({
            data: {
                routineId,
                productId,
                timeOfDay: normalizedTime
...
async function DELETE(request, context) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].routineProduct.updateMany({
            where: {
                routineId,
                productId,
                removedAt: null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d29569d1._.js.map